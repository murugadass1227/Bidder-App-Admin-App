...
var UpdateAuctionDto = /** @class */ (function (_super) {
    __extends(UpdateAuctionDto, _super);
    function UpdateAuctionDto() {
...
}((0, mapped_types_1.PartialType)(create_auction_dto_1.CreateAuctionDto)));
