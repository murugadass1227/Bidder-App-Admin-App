...
var create_bid_dto_1 = require("./dto/create-bid.dto");
...
var BidController = /** @class */ (function () {
    function BidController(bidService) {
        this.bidService = bidService;
    }
    BidController.prototype.place = function (userId, dto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.bidService.place(userId, dto)];
            });
        });
    };
    BidController.prototype.findByAuction = function (auctionId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.bidService.findByAuction(auctionId)];
            });
        });
    };
    BidController.prototype.myBids = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.bidService.findByUser(userId)];
            });
        });
    };
    __decorate([
    ...
    ], BidController.prototype, "place", null);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [String]),
        __metadata("design:returntype", Promise)
    ], BidController.prototype, "myBids", null);
